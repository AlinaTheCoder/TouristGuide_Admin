        ...
        const fetchActivityDetails = async () => {
            try {
                ...
                if (!error.response) {
                  ...
                  Alert.alert('Error', 'Failed to load Rejected Activity Details!');
                }
                setActivities([]);
              } finally {
                setLoading(false);
    ...
    if (loading) {
        return (
            <View style={styles.loadingContainer}>
                ...
                <Text style={styles.loadingText}>Loading Rejected Activity...</Text>
            </View>
        );
    }
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContainer}>
                        ...
                        <Text style={styles.modalHeader}>Declined</Text>
                        <Text style={styles.modalContent}>
                            Verification Date: {formatDate(activityData.rejectedAt)}
                        </Text>
                        <Text style={styles.modalContent}>
                            Verification Time: {formatTime(activityData.rejectedAt)}
                        </Text>
                    </View>
                </View>
            </Modal>
...
const styles = StyleSheet.create({
    ...
    hostingContainer: {
        // Added placeholder for this style to ensure no errors
    }
});
...
export default RejectedActivityDetails;
